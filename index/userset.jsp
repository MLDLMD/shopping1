...
<body class="smoothscroll enable-animation">
	...
	<div id="wrapper">
		...
		<table align="center" style="width: 900px" border="1" rules="none">
			...
			<form action="<%=request.getContextPath() %>/user_settingServlet?id=${user.id }" method="post">
			<tr>
				<td>
					&nbsp;&nbsp;&nbsp;<input type="text" name="nickName" style="width: 430px" value="li">
				</td>
				<td>
					<input type="text" name="email" style="width: 430px" value="1776411789@qq.com">
				</td>
			</tr>
			<tr>
