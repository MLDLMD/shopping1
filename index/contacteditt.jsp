<%@page import="edu.jmi.shop.bean.Contact"%>
...
c=(Contact)session.getAttribute("c");
%>
</script>
<body class="smoothscroll enable-animation">
	...
	<div id="wrapper">
		...
		<table align="center" style="width: 900px" border="1" rules="none">
			...
			<form action="${pageContext.request.contextPath}/Upcontacts?id=${user.id}" method="post">
			...
			<tr>
				<td colspan="3">
					&nbsp;&nbsp;&nbsp;<input type="text" name="name"  value="<%=c.getName() %>" style="width: 400px">
				</td>
				<td colspan="2">
					<input type="text" name="mobile" value="<%=c.getMobile()%>" style="width: 400px">
				</td>
			</tr>
			<tr>
				<td colspan="5">&nbsp;&nbsp;&nbsp;地址*</td>
			...
			<tr>
				<td colspan="5">&nbsp;&nbsp;&nbsp;<input type="text" name="address" value="<%=c.getAddress() %>" style="width: 845px"></td>
			</tr>
			<tr>
