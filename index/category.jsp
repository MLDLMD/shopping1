				...
				<div class='row'>
					<div
						...
						<%
							...
							List<ProductCategory> categoryList = productCategoryDao.selectbyid(ID);
							for(ProductCategory productCategory:categoryList){
								List<Product> productList = productDao.selectByCategoryId(productCategory.getId(), 8);
					...
					<div
						...
						<div class="side-nav margin-bottom-60">
							...
							<ul
								...
								<%
								 	List<ProductCategory> categoryList1 = productCategoryDao.selectAll();
