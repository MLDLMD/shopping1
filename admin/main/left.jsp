        ...
        <ul class="nav" id="side-menu">
            <li id="leftMenuProduct">
                ...
                <ul class="nav nav-second-level">
                    <li><a href="${pageContext.request.contextPath}/ProductCategorylistServlet">商品分类管理</a></li>
            ...
            <li id="leftMenuOrder">
                ...
                <ul class="nav nav-second-level">
                    <li><a href="${pageContext.request.contextPath}/admin/order/select.jsp">查看订单</a></li>
                </ul>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/admin/user/User.jsp"><span class="nav-label">用户管理</span></a>
            </li>
            <li>
